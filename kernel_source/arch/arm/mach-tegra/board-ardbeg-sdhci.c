...
//MMC_UHS_MASK_SDR104+max_clock136M=SDR50 
//MMC_UHS_MASK_DDR50+clock136M=SDR104(208M)
...
static struct resource ardbeg_bcm4339_bluetooth_resources[] = {
	[0] = {
		.name   = "bten_gpio",
		.start  = TEGRA_GPIO_PH0,
		.end    = TEGRA_GPIO_PH0,
		.flags  = IORESOURCE_IO,
	},
	[1] = {
		.name = "btwake_gpio",
		.start  = TEGRA_GPIO_PI5,
		.end    = TEGRA_GPIO_PI5,
		.flags  = IORESOURCE_IO,
	},
	[2] = {
		.name = "bthostwake_gpio",
...
static struct platform_device ardbeg_bcm4339_bluetooth_device = {
	.name = "bcm4339_bluetooth",
	.id             = 0,
	.resource	= ardbeg_bcm4339_bluetooth_resources,
	.num_resources	= ARRAY_SIZE(ardbeg_bcm4339_bluetooth_resources),
};
...
#define ARDBEG_WIFI_MAC_ADDR_FILE	"/lib/firmware/brcm/wifi_mac.txt"
...
int __init ardbeg_sdhci_init(void)
{
	...
	platform_device_register(&ardbeg_bcm4339_bluetooth_device);
