...
static struct tegra12_emc_table jetson_tk1_ddr3_emc_table[] = {
	{
		0x19,       /* V5.0.18 */
		"001_12750_NoCfgVersion_V5.0.18_V1.1", /* DVFS table version */
		12750,      /* SDRAM frequency */
		800,        /* min voltage */
		800,        /* gpu min voltage */
		"pllp_out0", /* clock source id */
	...
	{
		0x19,       /* V5.0.18 */
		"001_20400_NoCfgVersion_V5.0.18_V1.1", /* DVFS table version */
		20400,      /* SDRAM frequency */
		800,        /* min voltage */
		800,        /* gpu min voltage */
		"pllp_out0", /* clock source id */
	...
	{
		0x19,       /* V5.0.18 */
		"001_40800_NoCfgVersion_V5.0.18_V1.1", /* DVFS table version */
		40800,      /* SDRAM frequency */
		800,        /* min voltage */
		800,        /* gpu min voltage */
		"pllp_out0", /* clock source id */
	...
	{
		0x19,       /* V5.0.18 */
		"001_68000_NoCfgVersion_V5.0.18_V1.1", /* DVFS table version */
		68000,      /* SDRAM frequency */
		800,        /* min voltage */
		800,        /* gpu min voltage */
		"pllp_out0", /* clock source id */
	...
	{
		0x19,       /* V5.0.18 */
		"001_102000_NoCfgVersion_V5.0.18_V1.1", /* DVFS table version */
		102000,     /* SDRAM frequency */
		800,        /* min voltage */
		800,        /* gpu min voltage */
		"pllp_out0", /* clock source id */
	...
	{
		0x19,       /* V5.0.18 */
		"001_204000_NoCfgVersion_V5.0.18_V1.1", /* DVFS table version */
		204000,     /* SDRAM frequency */
		800,        /* min voltage */
		800,        /* gpu min voltage */
		"pllp_out0", /* clock source id */
	...
	{
		0x19,       /* V5.0.18 */
		"001_300000_NoCfgVersion_V5.0.18_V1.1", /* DVFS table version */
		300000,     /* SDRAM frequency */
		820,        /* min voltage */
		820,        /* gpu min voltage */
		"pllc_out0", /* clock source id */
	...
	{
		0x19,       /* V5.0.18 */
		"001_396000_NoCfgVersion_V5.0.18_V1.1", /* DVFS table version */
		396000,     /* SDRAM frequency */
		850,        /* min voltage */
		850,        /* gpu min voltage */
		"pllm_out0", /* clock source id */
	...
	{
		0x19,       /* V5.0.18 */
		"001_528000_NoCfgVersion_V5.0.18_V1.1", /* DVFS table version */
		528000,     /* SDRAM frequency */
		880,        /* min voltage */
		870,        /* gpu min voltage */
		"pllm_ud",  /* clock source id */
	...
	{
		0x19,       /* V5.0.18 */
		"001_600000_NoCfgVersion_V5.0.18_V1.1", /* DVFS table version */
		600000,     /* SDRAM frequency */
		910,        /* min voltage */
		910,        /* gpu min voltage */
		"pllc_ud",  /* clock source id */
	...
	{
		0x19,       /* V5.0.18 */
		"001_792000_NoCfgVersion_V5.0.18_V1.1", /* DVFS table version */
		792000,     /* SDRAM frequency */
		980,        /* min voltage */
		980,        /* gpu min voltage */
		"pllm_ud",  /* clock source id */
		...
		31,         /* number of up_down_regs */
		{
			...
			0x007f800e, /* EMC_DLL_XFORM_DQ0 */
			0x007f800e, /* EMC_DLL_XFORM_DQ1 */
			0x007f800e, /* EMC_DLL_XFORM_DQ2 */
			0x007f800e, /* EMC_DLL_XFORM_DQ3 */
			0x0007f80e, /* EMC_DLL_XFORM_DQ4 */
			0x0007f80e, /* EMC_DLL_XFORM_DQ5 */
			0x0007f80e, /* EMC_DLL_XFORM_DQ6 */
			0x0007f80e, /* EMC_DLL_XFORM_DQ7 */
			0x100002a0, /* EMC_XM2CMDPADCTRL */
			0x00000000, /* EMC_XM2CMDPADCTRL4 */
			0x00111111, /* EMC_XM2CMDPADCTRL5 */
			0x0120113d, /* EMC_XM2DQSPADCTRL2 */
	...
	{
		0x19,       /* V5.0.18 */
		"001_924000_NoCfgVersion_V5.0.18_V1.1", /* DVFS table version */
		924000,     /* SDRAM frequency */
		1010,       /* min voltage */
		1010,       /* gpu min voltage */
		"pllm_ud",  /* clock source id */
		...
		31,         /* number of up_down_regs */
		{
			...
			0x00000007, /* EMC_DLI_TRIM_TXDQS4 */
			0x00000005, /* EMC_DLI_TRIM_TXDQS5 */
			...
			0x00000007, /* EMC_DLI_TRIM_TXDQS12 */
			0x00000005, /* EMC_DLI_TRIM_TXDQS13 */
...
static struct tegra12_emc_table jetson_tk1_pm377_ddr3_emc_table[] = {
	{
		0x19,	    /* V5.0.14 */
		"01_102000_NoCfgVersion_V5.0.14_V1.1", /* DVFS table version */
		102000,     /* SDRAM frequency */
		800,	    /* min voltage */
		800,	    /* gpu min voltage */
		"pllp_out0", /* clock source id */
	...
	{
		0x19,	    /* V5.0.14 */
		"01_204000_NoCfgVersion_V5.0.14_V1.1", /* DVFS table version */
		204000,     /* SDRAM frequency */
		800,	    /* min voltage */
		800,	    /* gpu min voltage */
		"pllp_out0", /* clock source id */
	...
	{
		0x19,	    /* V5.0.14 */
		"01_300000_NoCfgVersion_V5.0.14_V1.1", /* DVFS table version */
		300000,     /* SDRAM frequency */
		820,	    /* min voltage */
		820,	    /* gpu min voltage */
		"pllc_out0", /* clock source id */
	...
	{
		0x19,	    /* V5.0.14 */
		"01_396000_NoCfgVersion_V5.0.14_V1.1", /* DVFS table version */
		396000,     /* SDRAM frequency */
		850,	    /* min voltage */
		850,	    /* gpu min voltage */
		"pllm_out0", /* clock source id */
	...
	{
		0x19,	    /* V5.0.14 */
		"01_528000_NoCfgVersion_V5.0.14_V1.1", /* DVFS table version */
		528000,     /* SDRAM frequency */
		880,	    /* min voltage */
		870,	    /* gpu min voltage */
		"pllm_ud",  /* clock source id */
	...
	{
		0x19,	    /* V5.0.14 */
		"01_600000_NoCfgVersion_V5.0.14_V1.1", /* DVFS table version */
		600000,     /* SDRAM frequency */
		910,	    /* min voltage */
		910,	    /* gpu min voltage */
		"pllc_ud",  /* clock source id */
	...
	{
		0x19,	    /* V5.0.14 */
		"01_792000_NoCfgVersion_V5.0.14_V1.1", /* DVFS table version */
		792000,     /* SDRAM frequency */
		980,	    /* min voltage */
		980,	    /* gpu min voltage */
		"pllm_ud",  /* clock source id */
	...
	{
		0x19,	    /* V5.0.14 */
		"01_924000_NoCfgVersion_V5.0.14_V1.1", /* DVFS table version */
		924000,     /* SDRAM frequency */
		1010,	    /* min voltage */
		1010,	    /* gpu min voltage */
		"pllm_ud",  /* clock source id */
...
static struct tegra12_emc_pdata jetson_tk1_PM377_4GB_emc_pdata = {
	.description = "ardbeg_emc_tables",
	.tables = jetson_tk1_pm377_ddr3_emc_table,
	.num_tables = ARRAY_SIZE(jetson_tk1_pm377_ddr3_emc_table),
};
...
int __init ardbeg_emc_init(void)
{
	...
	if (of_find_compatible_node(NULL, NULL, "nvidia,tegra12-emc")) {
		...
		case BOARD_PM377:
			if (of_machine_is_compatible("nvidia,jetson-tk1")) {
				pr_info("Loading jetson TK1 - PM377 4GB EMC tables.\n");
				tegra_emc_device.dev.platform_data =
					&jetson_tk1_PM377_4GB_emc_pdata;
			}
			break;
		default:
