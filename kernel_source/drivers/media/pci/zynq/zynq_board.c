...
static void rls_imp(struct vpif_vidoe_pipelie_entity* handle, void __iomem *pci_base_addr) {
	...
	switch (id) {
		case SCALER0:
			is_scaler = 1; index =0; break;
		case SCALER1:
			is_scaler = 1; index =1; break;
		case SCALER2:
			is_scaler = 1; index =2; break;
		case SCALER3:
			is_scaler = 1; index =3; break;
		case VSELECTOR:
			is_vselector = 1; break;
		case VDMA0:
			is_vdma = 1; index = 0; break;
		case VDMA1:
			is_vdma = 1; index = 1; break;
		case VDMA2:
			is_vdma = 1; index = 2; break;
		case VDMA3:
			is_vdma = 1; index = 3; break;
		case OSD0:
			is_osd = 1; index = 0; break;
		case OSD1:
			is_osd = 1; index = 1; break;
		case CRESAMPLER0:
			is_resampler = 1; index =0; break;
		case CRESAMPLER1:
			is_resampler = 1; index =1; break;
		case CRESAMPLER2:
			is_resampler = 1; index =2; break;
		case CRESAMPLER3:
			is_resampler = 1; index =3; break;
		case CRESAMPLER4:
			is_resampler = 1; index = 4; break;
		case VTIMING0:
			is_vtiming = 1; index = 0; break;
		case VTIMING1:
			is_vtiming = 1; index = 1; break;	
		default:
			return;
	}
...
static void dump_regs_imp(struct vpif_vidoe_pipelie_entity* handle) {
	...
	switch (id) {
		...
		case OSD1:
			...
			break;
		case CRESAMPLER0:
			is_resampler = 1; index =0; 
			dump_resampler_regs(index);
			break;
		case CRESAMPLER1:
			is_resampler = 1; index =1; 
			dump_resampler_regs(index);
			break;
		case CRESAMPLER2:
			is_resampler = 1; index =2; 
			dump_resampler_regs(index);
			break;
		case CRESAMPLER3:
			is_resampler = 1; index =3; 
			dump_resampler_regs(index);
			break;
		case CRESAMPLER4:
			is_resampler = 1; index = 4;
			 dump_resampler_regs(index);
			break;
		case VTIMING0:
			is_vtiming = 1; index = 0; break;
...
const char *to_video_pipelin_entity_name(vpif_vidoe_pipelie_entity_id_t  id) {
	...
	switch (id) {
		case SCALER0: return "SCALER0";
		case SCALER1: return  "SCALER1";
		case SCALER2: return  "SCALER2";
		case SCALER3: return  "SCALER3";
		case CRESAMPLER0: return  "CRESAMPLER0";
		case CRESAMPLER1: return  "CRESAMPLER1";
		case CRESAMPLER2: return  "CRESAMPLER2";
		case CRESAMPLER3: return  "CRESAMPLER3";
		case CRESAMPLER4: return  "CRESAMPLER4";
		case VSELECTOR : return  "VSELECTOR";
		case VDMA0: return "VDMA0";
		case VDMA1: return "VDMA1";
		case VDMA2: return "VDMA2";
		case VDMA3: return "VDMA3";
		case OSD0: return "OSD0";
		case OSD1: return "OSD1";
		case VTIMING0: return "VTIMING0";
		case VTIMING1: return "VTIMING1";
		case VIN0: return "VIN0";
		case VIN1: return "VIN1";
		case VIN2: return "VIN2";
		case VOUT0: return "VOUT0";
		case VOUT1: return "VOUT1";
		case PCIEIF: return "PCIEIF";
		default: return "UNKOWNID";
	}
}
...
const char *to_video_data_pin_name(vpif_video_data_pin_t pin) {
	...
	switch (pin) {
		case VIN0_IN: return "VIN0_IN";
		case VIN0_OUT: return "VIN0_OUT";
		case VIN1_IN: return "VIN1_IN";
		case VIN1_OUT: return "VIN1_OUT";
		case VIN2_IN: return "VIN2_IN";
		case VIN2_OUT: return "VIN2_OUT";
		case VOUT0_IN: return "VOUT0_IN";
		case VOUT0_OUT: return "VOUT0_OUT";
		case VOUT1_IN: return "VOUT1_IN";
		case VOUT1_OUT: return "VOUT1_OUT";
		case OSD0_IN: return "OSD0_IN";
		case OSD0_OUT: return "OSD0_OUT";
		case OSD1_IN: return "OSD1_IN";
		case OSD1_OUT: return "OSD1_OUT";
		case SCALER0_IN: return "SCALER0_IN";
		case SCALER0_OUT: return "SCALER0_OUT";
		case SCALER1_IN: return "SCALER1_IN";
		case SCALER1_OUT: return "SCALER1_OUT";
		case SCALER2_IN: return "SCALER2_IN";
		case SCALER2_OUT: return "SCALER2_OUT";
		case SCALER3_IN: return "SCALER3_IN";
		case SCALER3_OUT: return "SCALER3_OUT";
		case VSELECTOR_IN: return "VSELECTOR_IN";
		case VSELECTOR_OUT: return "VSELECTOR_OUT";
		case VDMA0_IN: return "VDMA0_IN ";
		case VDMA0_OUT: return  "VDMA0_OUT";
		case VDMA1_IN: return "VDMA1_IN ";
		case VDMA1_OUT: return  "VDMA1_OUT";
		case VDMA2_IN: return "VDMA2_IN ";
		case VDMA2_OUT: return  "VDMA2_OUT";
		case VDMA3_IN: return "VDMA3_IN ";
		case VDMA3_OUT: return  "VDMA3_OUT";
		case CRESAMPLER0_IN: return "CRESAMPLER0_IN";
		case CRESAMPLER0_OUT: return  "CRESAMPLER0_OUT";
		case CRESAMPLER1_IN: return "CRESAMPLER1_IN";
		case CRESAMPLER1_OUT: return  "CRESAMPLER1_OUT";
		case CRESAMPLER2_IN: return "CRESAMPLER2_IN";
		case CRESAMPLER2_OUT: return  "CRESAMPLER2_OUT";
		case CRESAMPLER3_IN: return "CRESAMPLER3_IN";
		case CRESAMPLER3_OUT: return  "CRESAMPLER3_OUT";
		case CRESAMPLER4_IN: return "CRESAMPLER4_IN";
		case CRESAMPLER4_OUT: return  "CRESAMPLER4_OUT";
		case PCIEIF_IN: return "PCIEIF_IN";
		case PCIEIF_OUT: return "PCIEIF_OUT";
		default: return "UNKOWNPN";
	}
}
